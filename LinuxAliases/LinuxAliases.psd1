#
# Module manifest for module 'LinuxAliases'
#

@{

# Script module or binary module file associated with this manifest.
RootModule = 'LinuxAliases.psm1'
...
FunctionsToExport = 'grep', 'touch', 'df', 'sed', 'which', 'export', 'pkill', 
               'pgrep', 'head', 'tail', 'unzip', 'mkcd', 'll', 'find-file', 
               'cpy', 'pst', 'sysinfo'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Linux', 'Unix', 'Bash', 'Aliases', 'Cross-Platform')
